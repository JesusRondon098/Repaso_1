...
function Zodiac(day, month) {
    var array = ["Acuario", "Piscis", "Aries", "Tauro", "Gemenis", "Cancer", "Leo", "Virgo", "Libra", "Escorpio", "Sagitario", "Capricornio"];
...
function isEven(numero) {
    if (numero % 2 == 0) {
        return "El ".concat(numero, ", es un numero par.");
    }
    else {
        return "El ".concat(numero, ", es un numero impar.");
    }
}
